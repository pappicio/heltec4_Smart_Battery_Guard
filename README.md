...
MA ATTENZIONE: Devono erogare dai 2.9 ai 3.0V max (a me i 3 che ho provato stavano tra i 2.8 e 3.0V, con ponticello 3.3V saldato), se superano i 3V, verranno sballate le misurazioni e innalzate troppo le soglie per spegnimento/accensione, e dovrete abbassare i livelli sul codice sorgente, ma sarebbe preferibile invece usare un LDO:

IN ALTERNAVITA E FORTEMENTE COMSIGLIATO, ALLO STEP DOWN, potrete usare un ldo da 2.5V (o da 3.0V), che trovate su aliexpress
