...
;supervisore_energetico.mbas,328 :: 		while (TRUE)
L__main60:
;supervisore_energetico.mbas,330 :: 		if (INTCON.GPIF = 1) then
	BTFSS      INTCON+0, 0
	GOTO       L__main65
;supervisore_energetico.mbas,331 :: 		dummy = GPIO
	MOVF       GPIO+0, 0
	MOVWF      _dummy+0
;supervisore_energetico.mbas,332 :: 		INTCON.GPIF = 0
	BCF        INTCON+0, 0
L__main65:
;supervisore_energetico.mbas,336 :: 		if (GPIO.3 = 0) then
	BTFSC      GPIO+0, 3
	GOTO       L__main68
;supervisore_energetico.mbas,337 :: 		i = 0
	CLRF       _i+0
;supervisore_energetico.mbas,338 :: 		while (GPIO.3 = 0) and (i < 50)
L__main71:
	BTFSC      GPIO+0, 3
	GOTO       L__main203
	BSF        117, 0
...
L__main204:
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main72
;supervisore_energetico.mbas,339 :: 		Delay_Safe_ms(100) ' Campionamento pressione (100ms * 50 = 5s max)
	MOVLW      100
	MOVWF      FARG_Delay_Safe_ms_n+0
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,340 :: 		i = i + 1
	INCF       _i+0, 1
;supervisore_energetico.mbas,341 :: 		if (i = 10) then
	MOVF       _i+0, 0
	XORLW      10
	BTFSS      STATUS+0, 2
	GOTO       L__main76
;supervisore_energetico.mbas,342 :: 		GPIO.2 = 1     ' Accende LED dopo 1 secondo di pressione
	BSF        GPIO+0, 2
L__main76:
;supervisore_energetico.mbas,344 :: 		if (i = 25) then
	MOVF       _i+0, 0
	XORLW      25
	BTFSS      STATUS+0, 2
	GOTO       L__main79
;supervisore_energetico.mbas,345 :: 		GPIO.2 = 0     ' Spegne LED dopo 2.5 secondi (cambio modalità)
	BCF        GPIO+0, 2
L__main79:
;supervisore_energetico.mbas,347 :: 		wend
	GOTO       L__main71
L__main72:
;supervisore_energetico.mbas,350 :: 		if (i >= 10) and (i < 25) then
	MOVLW      10
	SUBWF      _i+0, 0
	MOVLW      255
	BTFSS      STATUS+0, 0
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main82
;supervisore_energetico.mbas,351 :: 		GPIO.2 = 0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,352 :: 		Leggi_Batteria_mV()
	CALL       _Leggi_Batteria_mV+0
;supervisore_energetico.mbas,355 :: 		GPIO.0 = 1
	BSF        GPIO+0, 0
;supervisore_energetico.mbas,356 :: 		Delay_Safe_ms(2000)
	MOVLW      208
	MOVWF      FARG_Delay_Safe_ms_n+0
	MOVLW      7
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,360 :: 		if (batteria_mv > soglia_off) then
	MOVF       _batteria_mv+3, 0
	SUBWF      _soglia_off+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main205
...
L__main205:
	BTFSC      STATUS+0, 0
	GOTO       L__main85
;supervisore_energetico.mbas,361 :: 		GPIO.0 = 0
	BCF        GPIO+0, 0
L__main85:
;supervisore_energetico.mbas,363 :: 		gpio.2=0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,364 :: 		if (batteria_mv < soglia_on) then
	MOVF       _soglia_on+3, 0
...
L__main206:
	BTFSC      STATUS+0, 0
	GOTO       L__main88
;supervisore_energetico.mbas,365 :: 		soglia_batteria
	CALL       _soglia_batteria+0
L__main88:
;supervisore_energetico.mbas,367 :: 		sveglie_wdt = 0
	CLRF       _sveglie_wdt+0
	CLRF       _sveglie_wdt+1
;supervisore_energetico.mbas,368 :: 		conteggio_cicli = 0
	CLRF       _conteggio_cicli+0
	CLRF       _conteggio_cicli+1
	CLRF       _conteggio_cicli+2
	CLRF       _conteggio_cicli+3
L__main82:
;supervisore_energetico.mbas,374 :: 		if (i >= 25) and (i < 50) then
	MOVLW      25
	SUBWF      _i+0, 0
	MOVLW      255
	BTFSS      STATUS+0, 0
...
;supervisore_energetico.mbas,375 :: 		GPIO.2 = 0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,376 :: 		Leggi_Batteria_mV()
	CALL       _Leggi_Batteria_mV+0
;supervisore_energetico.mbas,377 :: 		Delay_Safe_ms(1000)
	MOVLW      232
	MOVWF      FARG_Delay_Safe_ms_n+0
	MOVLW      3
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,380 :: 		val_da_lampeggiare = word(batteria_mv)
	MOVF       _batteria_mv+0, 0
	MOVWF      _val_da_lampeggiare+0
	MOVF       _batteria_mv+1, 0
	MOVWF      _val_da_lampeggiare+1
;supervisore_energetico.mbas,382 :: 		Estrai_e_Lampeggia(1000) ' Migliaia
	MOVLW      232
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+0
	MOVLW      3
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+1
	CALL       _Estrai_e_Lampeggia+0
;supervisore_energetico.mbas,383 :: 		Estrai_e_Lampeggia(100)  ' Centinaia
	MOVLW      100
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+0
	CLRF       FARG_Estrai_e_Lampeggia_divisore+1
	CALL       _Estrai_e_Lampeggia+0
;supervisore_energetico.mbas,384 :: 		Estrai_e_Lampeggia(10)   ' Decine
	MOVLW      10
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+0
	CLRF       FARG_Estrai_e_Lampeggia_divisore+1
	CALL       _Estrai_e_Lampeggia+0
;supervisore_energetico.mbas,385 :: 		Lampeggia_Cifra(0)       ' Unità fisse
	CLRF       FARG_Lampeggia_Cifra_c+0
	CALL       _Lampeggia_Cifra+0
;supervisore_energetico.mbas,388 :: 		if (RTC_presente = 1) then
...
;supervisore_energetico.mbas,389 :: 		Delay_Safe_ms(1000)
	...
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,390 :: 		lampi (2,100)
	MOVLW      2
	MOVWF      FARG_Lampi_n+0
	MOVLW      100
	MOVWF      FARG_Lampi_t_on+0
	CLRF       FARG_Lampi_t_on+1
	CALL       _Lampi+0
;supervisore_energetico.mbas,391 :: 		Leggi_Ora_RTC()
	CALL       _Leggi_Ora_RTC+0
;supervisore_energetico.mbas,392 :: 		gpio.2=1
	BSF        GPIO+0, 2
;supervisore_energetico.mbas,393 :: 		delay_safe_ms(100)
	MOVLW      100
	MOVWF      FARG_Delay_Safe_ms_n+0
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,394 :: 		gpio.2=0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,395 :: 		Delay_Safe_ms(1000)
	...
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,397 :: 		val_da_lampeggiare = word(ore)
	MOVF       _ore+0, 0
	MOVWF      _val_da_lampeggiare+0
	CLRF       _val_da_lampeggiare+1
;supervisore_energetico.mbas,398 :: 		Estrai_e_Lampeggia(10)
	MOVLW      10
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+0
	CLRF       FARG_Estrai_e_Lampeggia_divisore+1
	CALL       _Estrai_e_Lampeggia+0
;supervisore_energetico.mbas,399 :: 		Lampeggia_Cifra(byte(val_da_lampeggiare)) ' Il resto sono le unità
...
;supervisore_energetico.mbas,401 :: 		Delay_Safe_ms(1000)
	...
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,404 :: 		val_da_lampeggiare = word(minuti)
	MOVF       _minuti+0, 0
	MOVWF      _val_da_lampeggiare+0
	CLRF       _val_da_lampeggiare+1
;supervisore_energetico.mbas,405 :: 		Estrai_e_Lampeggia(10)
	MOVLW      10
	MOVWF      FARG_Estrai_e_Lampeggia_divisore+0
	CLRF       FARG_Estrai_e_Lampeggia_divisore+1
	CALL       _Estrai_e_Lampeggia+0
;supervisore_energetico.mbas,406 :: 		Lampeggia_Cifra(byte(val_da_lampeggiare))
	MOVF       _val_da_lampeggiare+0, 0
	MOVWF      FARG_Lampeggia_Cifra_c+0
	CALL       _Lampeggia_Cifra+0
L__main94:
;supervisore_energetico.mbas,407 :: 		end if
L__main91:
;supervisore_energetico.mbas,412 :: 		if (i >= 50) then
	MOVLW      50
	SUBWF      _i+0, 0
	BTFSS      STATUS+0, 0
	GOTO       L__main97
;supervisore_energetico.mbas,413 :: 		GPIO.0 = 1                      ' Distacca il carico (Heltec OFF)
	BSF        GPIO+0, 0
;supervisore_energetico.mbas,415 :: 		for j = 1 to 20
	MOVLW      1
	MOVWF      _j+0
L__main100:
;supervisore_energetico.mbas,416 :: 		GPIO.2 = not GPIO.2         ' Lampeggio veloce di conferma
	MOVLW      4
	XORWF      GPIO+0, 1
;supervisore_energetico.mbas,417 :: 		Delay_Safe_ms(100)
	...
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,418 :: 		next j
	MOVF       _j+0, 0
	XORLW      20
	BTFSC      STATUS+0, 2
	GOTO       L__main103
	...
	GOTO       L__main100
L__main103:
;supervisore_energetico.mbas,419 :: 		GPIO.2 = 0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,420 :: 		in_manutenzione = true          ' Entra nel loop di blocco
	MOVLW      255
	MOVWF      _in_manutenzione+0
;supervisore_energetico.mbas,421 :: 		while (in_manutenzione = true)
L__main105:
	MOVF       _in_manutenzione+0, 0
	XORLW      255
	BTFSS      STATUS+0, 2
	GOTO       L__main106
;supervisore_energetico.mbas,423 :: 		GPIO.2 = 1
	BSF        GPIO+0, 2
;supervisore_energetico.mbas,424 :: 		Delay_Safe_ms(500)
	MOVLW      244
	MOVWF      FARG_Delay_Safe_ms_n+0
	MOVLW      1
	MOVWF      FARG_Delay_Safe_ms_n+1
...
;supervisore_energetico.mbas,425 :: 		GPIO.2 = 0
	BCF        GPIO+0, 2
;supervisore_energetico.mbas,426 :: 		if (GPIO.3 = 0) then        ' Controlla se si preme di nuovo per uscire
	BTFSC      GPIO+0, 3
	GOTO       L__main110
;supervisore_energetico.mbas,427 :: 		i = 0
	CLRF       _i+0
;supervisore_energetico.mbas,428 :: 		while (GPIO.3 = 0) and (i < 50)
L__main113:
	BTFSC      GPIO+0, 3
	GOTO       L__main207
	BSF        117, 0
...
;supervisore_energetico.mbas,429 :: 		Delay_Safe_ms(100)
	...
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,430 :: 		i = i + 1
	INCF       _i+0, 1
;supervisore_energetico.mbas,431 :: 		wend
	GOTO       L__main113
L__main114:
;supervisore_energetico.mbas,432 :: 		if (i >= 50) then       ' Uscita dopo altri 5 secondi
	MOVLW      50
	SUBWF      _i+0, 0
	BTFSS      STATUS+0, 0
	GOTO       L__main118
;supervisore_energetico.mbas,433 :: 		in_manutenzione = false
	CLRF       _in_manutenzione+0
;supervisore_energetico.mbas,435 :: 		for j = 1 to 20
	MOVLW      1
	MOVWF      _j+0
L__main121:
;supervisore_energetico.mbas,436 :: 		GPIO.2 = not GPIO.2
	MOVLW      4
	XORWF      GPIO+0, 1
;supervisore_energetico.mbas,437 :: 		Delay_Safe_ms(100)
	MOVLW      100
	MOVWF      FARG_Delay_Safe_ms_n+0
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,438 :: 		next j
	MOVF       _j+0, 0
	XORLW      20
	BTFSC      STATUS+0, 2
	GOTO       L__main124
...
;supervisore_energetico.mbas,440 :: 		end if
	GOTO       L__main111
;supervisore_energetico.mbas,441 :: 		else
L__main110:
;supervisore_energetico.mbas,444 :: 		Delay_Safe_ms(500)
	MOVLW      244
	MOVWF      FARG_Delay_Safe_ms_n+0
	MOVLW      1
	MOVWF      FARG_Delay_Safe_ms_n+1
...
L__main111:
;supervisore_energetico.mbas,446 :: 		clrwdt
	CLRWDT
;supervisore_energetico.mbas,447 :: 		wend
	GOTO       L__main105
L__main106:
;supervisore_energetico.mbas,449 :: 		Leggi_Batteria_mV()
	CALL       _Leggi_Batteria_mV+0
;supervisore_energetico.mbas,450 :: 		if (batteria_mv > soglia_off) then GPIO.0 = 0 end if
	MOVF       _batteria_mv+3, 0
	SUBWF      _soglia_off+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main209
...
L__main209:
	...
	BCF        GPIO+0, 0
L__main126:
;supervisore_energetico.mbas,451 :: 		if (batteria_mv < soglia_on) then
	MOVF       _soglia_on+3, 0
	SUBWF      _batteria_mv+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main210
...
L__main210:
	BTFSC      STATUS+0, 0
	GOTO       L__main129
;supervisore_energetico.mbas,452 :: 		soglia_batteria
	CALL       _soglia_batteria+0
L__main129:
;supervisore_energetico.mbas,454 :: 		sveglie_wdt = 13 ' Forza controllo batteria subito
	MOVLW      13
	MOVWF      _sveglie_wdt+0
	CLRF       _sveglie_wdt+1
;supervisore_energetico.mbas,455 :: 		conteggio_cicli = 0
	CLRF       _conteggio_cicli+0
	CLRF       _conteggio_cicli+1
	CLRF       _conteggio_cicli+2
	CLRF       _conteggio_cicli+3
;supervisore_energetico.mbas,456 :: 		minuti_count = 0
	CLRF       _minuti_count+0
;supervisore_energetico.mbas,457 :: 		clrwdt
	CLRWDT
L__main97:
;supervisore_energetico.mbas,458 :: 		end if
L__main68:
;supervisore_energetico.mbas,462 :: 		if (in_manutenzione = false) then
	MOVF       _in_manutenzione+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main132
;supervisore_energetico.mbas,464 :: 		if (sveglie_wdt >= 13) then
	MOVLW      0
...
L__main211:
	BTFSS      STATUS+0, 0
	GOTO       L__main135
;supervisore_energetico.mbas,465 :: 		Leggi_Batteria_mV()
	CALL       _Leggi_Batteria_mV+0
;supervisore_energetico.mbas,467 :: 		if (batteria_mv <= soglia_off) then
	MOVF       _batteria_mv+3, 0
	SUBWF      _soglia_off+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main212
...
L__main212:
	BTFSS      STATUS+0, 0
	GOTO       L__main138
;supervisore_energetico.mbas,468 :: 		GPIO.0 = 1 ' Spegne Heltec
	BSF        GPIO+0, 0
;supervisore_energetico.mbas,469 :: 		spento=1
	MOVLW      1
	MOVWF      _spento+0
L__main138:
;supervisore_energetico.mbas,472 :: 		if (batteria_mv >= soglia_on) then
	MOVF       _soglia_on+3, 0
	SUBWF      _batteria_mv+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main213
...
L__main213:
	BTFSS      STATUS+0, 0
	GOTO       L__main141
;supervisore_energetico.mbas,473 :: 		GPIO.0 = 0 ' Accende Heltec
	BCF        GPIO+0, 0
;supervisore_energetico.mbas,474 :: 		spento=0
	CLRF       _spento+0
L__main141:
;supervisore_energetico.mbas,477 :: 		sveglie_wdt = 0 ' Reset qui dopo il controllo batteria
	CLRF       _sveglie_wdt+0
	CLRF       _sveglie_wdt+1
;supervisore_energetico.mbas,479 :: 		if (RTC_presente = 1) then
	MOVF       _RTC_presente+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L__main144
;supervisore_energetico.mbas,480 :: 		giorni_riavvio=0
	CLRF       _giorni_riavvio+0
;supervisore_energetico.mbas,481 :: 		minuti_count = minuti_count + 1
	INCF       _minuti_count+0, 1
	GOTO       L__main145
;supervisore_energetico.mbas,482 :: 		else
L__main144:
;supervisore_energetico.mbas,483 :: 		minuti_count = 0
	CLRF       _minuti_count+0
;supervisore_energetico.mbas,484 :: 		finestra_oraria=0
	CLRF       _finestra_oraria+0
...
;supervisore_energetico.mbas,504 :: 		Leggi_Ora_RTC()
	CALL       _Leggi_Ora_RTC+0
;supervisore_energetico.mbas,507 :: 		if finestra_oraria = 0 then
	MOVF       _finestra_oraria+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main159
;supervisore_energetico.mbas,509 :: 		if (ore = 4)  then
	MOVF       _ore+0, 0
	XORLW      4
	BTFSS      STATUS+0, 2
	GOTO       L__main162
...
;supervisore_energetico.mbas,513 :: 		Delay_Safe_ms(10000)
	...
	MOVWF      FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,514 :: 		if ((batteria_mv > soglia_off) and (spento = 0)) then GPIO.0 = 0 end if
	MOVF       _batteria_mv+3, 0
	SUBWF      _soglia_off+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main216
...
L__main163:
	GOTO       L__main160
;supervisore_energetico.mbas,522 :: 		else
L__main159:
;supervisore_energetico.mbas,525 :: 		if (ore >= 7) and (ore < 13) then 'dalle 7 alle 13 accendiamo
	MOVLW      7
	SUBWF      _ore+0, 0
	MOVLW      255
	BTFSS      STATUS+0, 0
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main174
;supervisore_energetico.mbas,527 :: 		if (giorno = 1) or (giorno = 2) or (giorno = 3) or (giorno = 4) or (giorno = 5) or (giorno = 6) or (giorno = 7)   then
	MOVF       _giorno+0, 0
	XORLW      1
	MOVLW      255
	BTFSS      STATUS+0, 2
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main177
;supervisore_energetico.mbas,528 :: 		if ((batteria_mv > soglia_off)  and (spento=0))  then
	MOVF       _batteria_mv+3, 0
	SUBWF      _soglia_off+3, 0
	BTFSS      STATUS+0, 2
	GOTO       L__main217
...
L__main217:
	...
	BTFSC      STATUS+0, 2
	GOTO       L__main180
;supervisore_energetico.mbas,530 :: 		GPIO.0 = 0
	BCF        GPIO+0, 0
	GOTO       L__main181
...
L__main174:
;supervisore_energetico.mbas,537 :: 		GPIO.0 = 1
	BSF        GPIO+0, 0
;supervisore_energetico.mbas,538 :: 		end if
L__main175:
;supervisore_energetico.mbas,539 :: 		end if
L__main160:
;supervisore_energetico.mbas,540 :: 		minuti_count = 0
	CLRF       _minuti_count+0
L__main156:
;supervisore_energetico.mbas,541 :: 		end if
L__main135:
;supervisore_energetico.mbas,545 :: 		sveglie_wdt = sveglie_wdt + 1    ' Incrementa conteggio risvegli
	INCF       _sveglie_wdt+0, 1
	BTFSC      STATUS+0, 2
	INCF       _sveglie_wdt+1, 1
;supervisore_energetico.mbas,546 :: 		clrwdt                            ' Pulizia watchdog
	CLRWDT
;supervisore_energetico.mbas,547 :: 		sleep                             ' Il chip dorme (Risparmio Max)
	SLEEP
;supervisore_energetico.mbas,548 :: 		nop                               ' Istruzione necessaria dopo lo sleep
	NOP
	GOTO       L__main133
;supervisore_energetico.mbas,550 :: 		else
L__main132:
;supervisore_energetico.mbas,552 :: 		Delay_Safe_ms(100)
	MOVLW      100
	MOVWF      FARG_Delay_Safe_ms_n+0
	CLRF       FARG_Delay_Safe_ms_n+1
	CALL       _Delay_Safe_ms+0
;supervisore_energetico.mbas,553 :: 		clrwdt
	CLRWDT
;supervisore_energetico.mbas,554 :: 		end if
L__main133:
;supervisore_energetico.mbas,555 :: 		wend
	GOTO       L__main60
L_end_main:
	GOTO       $+0
; end of _main
